...
export default function() {
  ...
  return {
    ...
    getData: function(entity, nid) {
      const e = entity || this.props.params.entity, id = nid || this.props.params.id;
    ...
    componentWillReceiveProps(nextProps) {
      if (nextProps.params && (nextProps.params.entity != this.props.params.entity || nextProps.params.id != this.props.params.id)) {
